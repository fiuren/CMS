    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            if ($id == "nuevo"){
                ...
                //Mensaje y redirección
                ($consulta > 0) ?
                    $this->view->redireccionConMensaje("admin/noticias","green","La noticia <strong>$titulo</strong> se ha creado correctamente.".$texto_img) :
                    $this->view->redireccionConMensaje("admin/noticias","red","Hubo un error al guardar en la base de datos.");
            }
            else{
                ...
                //Mensaje y redirección
                $this->view->redireccionConMensaje("admin/noticias","green","La noticia <strong>$titulo</strong> se ha guardado correctamente.".$texto_img);
